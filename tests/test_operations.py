...
def test_operation(a, b, operation, expected):
    '''Test all operators more efficiently with one function here'''
    calculation = Calculation.create(a, b, operation)
    assert calculation.perform() == expected, f"{operation.__name__} this operation unfortuately failed."
...
# Since divide by zero is only edge case, keep this separate
